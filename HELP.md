...
* The original package name 'com.java.microservice.spring-boot-hello-world-example' is invalid and this project uses 'com.java.microservice.springboothelloworldexample' instead.
